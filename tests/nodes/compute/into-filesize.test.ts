...
describe('into-filesize (compute)', () => {
  test('into-filesize: basic', async () => {
    const graph = {
      nodes: [
        { id: 'into-filesize', type: 'into-filesize', params: {} },
        { id: 'out', type: 'return', params: {} }
      ],
      edges: [
        { from: 'into-filesize', from_port: 'output', to: 'out', to_port: 'input' }
      ]
    };
