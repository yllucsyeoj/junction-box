...
describe('into-duration (compute)', () => {
  test('into-duration: basic', async () => {
    const graph = {
      nodes: [
        { id: 'into-duration', type: 'into-duration', params: {} },
        { id: 'out', type: 'return', params: {} }
      ],
      edges: [
        { from: 'into-duration', from_port: 'output', to: 'out', to_port: 'input' }
      ]
    };
